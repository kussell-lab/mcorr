...
MSA1=${ARCHIVE}/MSA_NM_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/500chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS183clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS183clusterseqs/${DATE}_slurm
