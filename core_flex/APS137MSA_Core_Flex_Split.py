...
sero_filelist = '/home/aps376/APS137_ngs/ST_list'
...
ref_dir = '/scratch/aps376/APS137_Archive/'
...
for sero_name in seros:
    ...
    for CF in range(0,2):
        ...
        ##usually ref_dir, changed for this
        refout_CF = ref_dir + 'NGS_' + sero_name + '_OUT/MSA_' + CF_names[CF] + '_ST-' + sero_name
...
##this is why your refgen files were so damn big
        ...
        print('done with %s for %s' %(CF_names[CF], 'ST-'+sero_name))
