...
#define directories
threshold = 90
date = "0309_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS169mcorr"
archive = "/scratch/aps376/recombo/APS169_SP_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS169mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS169mcorr/%s_slurm" % date
