...
complete_combolist = [("cluster141", "cluster171"),
         ("cluster142", "cluster162"),
         ("cluster142", "cluster171"),
         ("cluster152", "cluster162"),
         ("cluster152", "cluster171"),
         ("cluster152", "cluster174"),
         ("cluster158", "cluster171"),
         ("cluster159", "cluster171"),
         ("cluster161", "cluster171"),
         ("cluster161", "cluster173"),
         ("cluster161", "cluster174"),
         ("cluster162", "cluster171"),
         ("cluster163", "cluster171"),
         ("cluster165", "cluster171"),
         ("cluster169", "cluster171"),
         ("cluster169", "cluster173"),
         ("cluster169", "cluster174"),
         ("cluster170", "cluster171"),
         ("cluster1", "cluster2"),
         ("cluster75", "cluster171"),
         ("cluster83", "cluster171"),
         ("cluster83", "cluster173"),
         ("cluster85", "cluster162"),
         ("cluster85", "cluster171"),
         ("cluster85", "cluster173"),
         ("cluster89", "cluster162"),
         ("cluster89", "cluster163"),
         ("cluster89", "cluster165"),
         ("cluster89", "cluster169"),
         ("cluster89", "cluster171"),
         ("cluster89", "cluster173"),
         ("cluster89", "cluster174")
         ]

pairs = np.array_split(complete_combolist, 33)
