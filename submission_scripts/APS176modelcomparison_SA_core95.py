...
#define directories
threshold = 95
date = "0320_SA_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS176fitcompare"
archive = "/scratch/aps376/recombo/APS170_SA_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS176fitcompare/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS176fitcompare/%s_slurm" % date
...
sero_list = [11, 12, 21, 26, 31, 32, 45, 61, 78, 81, 85, 98, 104, 124, 132,
             137, 140, 143, 162, 178, 193, 207, 224, 246, 251, 254, 255, 270, 271, 275]
    ...
    for i in np.arange(0, len(pairs)):
        ...
        with open(job_file, "w+") as fh:
            ...
            for c in pairs_i:
                ...
                fh.writelines("\n")
                if c[0] != c[1]:
                    fh.writelines("mcorrFitCompare %s/%s_%s_XMFA_OUT.csv %s/%s_%s_fitcomparison || true\n"
