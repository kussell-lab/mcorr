...
#SBATCH --time=0:30:00
#SBATCH --mem=4GB
#SBATCH --job-name=APS159cluster
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS159cluster_slurm%j.out
...
export LC_ALL=C
##outfile
out="APS159_0113_NG_10thpercentile_cutoff"
...
echo "let's rock"
cd ${OUTDIR}
clusterSequences APS159distancematrix.npy strains ${out} --min_size=2
