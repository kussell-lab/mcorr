...
#define directories
threshold = 95
date = "0415_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS189mcorr"
archive = "/scratch/aps376/recombo/APS189_PA_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS189mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS189mcorr/%s_slurm" % date
...
sero_list = [10, 13, 14, 19, 20, 24, 45, 46, 49, 51, 53, 55, 76, 82, 83, 85, 86, 90]
