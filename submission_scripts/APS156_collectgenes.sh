...
Archive=${SCRATCH}/recombo/APS156_SP_Archive/SP_MASTER_OUT
...
CollectGeneAlignments ${sra_list} ${GFF} ${WRKD} ${Archive}/MSA_SP_MASTER --appendix ".pileup.fasta" --progress --buf_size=2500 --num_genome=5000
