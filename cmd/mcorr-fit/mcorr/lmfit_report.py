...
def main():
    ...
    parser.add_argument("--thetaS_init", type=float, help="set initial value for f in the fitting", default=0.00001)
    ...
    fitres = vary_fit(all.xvalues, all.yvalues, all.d_sample, r1_func, f_init, thetaS_init, phiS_init)
