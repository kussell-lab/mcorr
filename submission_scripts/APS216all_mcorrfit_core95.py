...
#define directories
threshold = 95
date = "0609_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS216mcorr"
archive = "/scratch/aps376/recombo/scratch/aps376/recombo/APS160_SP_Archive/corethreshold%s" % threshold
newarchive = "/scratch/aps376/recombo/APS216_SP_Archive"
submitdir = "/scratch/aps376/recombo/APS216mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS216mcorr/%s_slurm" % date
