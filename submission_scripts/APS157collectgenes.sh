...
#SBATCH --output=APS157collectgenes_slurm%j.out


##INPUTS
jobdir=/scratch/aps376/recombo/APS157map2multirefgen
fastq_list=${jobdir}/APS157_genomestats/201216_SRA_list
...
OUT=${OUTDIR}/APS157_DRR098680_XMFA
#WRKRS=14
...
CollectMultiGeneAlignments ${fastq_list} ${GFF_list} ${GFF_dir} ${WRKDIR} ${OUT} --progress --appendix=".pileup.fasta"
