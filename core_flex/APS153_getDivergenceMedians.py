...
def main():
    ...
    ##temp
    file_dir = '/Volumes/GoogleDrive/My Drive/hpc/recombo/APS153_saureus_Archive/'
    file_name = 'APS153_1119_saureus'
    out_dir = '/Users/asherpreskasteinberg/Desktop/code/recombo/APS153_saureus/'

    ##i am going to refer to these as serotypes just for convenience, but know ...
    ##they are sequence clusters!
    clusters = [1, 2, 3, 4, 5, 6, 7, 9, 10, 13, 14, 16, 17, 19, 20, 25, 27, 28, 30]
