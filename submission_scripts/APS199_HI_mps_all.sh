...
MSA1=${ARCHIVE}/MSA_HI_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/50chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS199clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS199clusterseqs/${DATE}_slurm
