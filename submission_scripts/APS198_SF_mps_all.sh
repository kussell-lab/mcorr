...
MSA1=${ARCHIVE}/MSA_SF_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/100chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS198clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS198clusterseqs/${DATE}_slurm
