...
#define directories
threshold = 90
date = "0808_SP_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS224mcorr"
archive = "/scratch/aps376/recombo/APS169_SP_Archive/corethreshold%s" % threshold
newarchive = "/scratch/aps376/recombo/APS224_SP_90_Archive"
submitdir = "/scratch/aps376/recombo/APS224mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS224mcorr/%s_slurm" % date
