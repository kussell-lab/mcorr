...
mkdir -p $SCRATCH/recombo/spneumoniae
...
python3 $HOME/ReferenceAlignmentGenerator/FetchSRA_APS2.py $SCRATCH/recombo/APS150_SRA/APS150_SRA_list $SCRATCH/recombo/spneumoniae
