...
//Write MSA for sequence clusters; option to split into core and flexible genomes
func writeClusters(alnFile string, clusterdict string, CFsplit bool, threshold int, showProgress bool, ncpu int) {
