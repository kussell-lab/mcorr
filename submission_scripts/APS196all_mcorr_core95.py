...
#define directories
threshold = 95
date = "0420_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS196mcorr"
archive = "/scratch/aps376/recombo/APS196_SS_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS196mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS196mcorr/%s_slurm" % date
...
sero_list = [15, 39, 65, 89, 96, 139, 140, 158, 160, 178, 185]
