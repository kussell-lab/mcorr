...
#define directories
threshold = 95
date = "0423_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS197mcorr"
archive = "/scratch/aps376/recombo/APS197_EC_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS197mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS197mcorr/%s_slurm" % date
...
sero_list = [101, 277, 416, 577, 635, 741, 900, 924, 988, 994, 997, 998, 999, 1001, 1029]
