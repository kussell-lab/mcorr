...
sero_filelist = '/Volumes/GoogleDrive/My Drive/hpc/APS137_ngs/APS137_200910_Archive/ST_list'
#ref_dir is the directory that contains the all of the serotype folders generated by pipeline.sh
ref_dir = '/Volumes/GoogleDrive/My Drive/hpc/APS137_ngs/APS137_200910_Archive/'
...
#Where the REFGEN master file is
refout_all = ref_dir + 'MSA_CORE_Master'

#Generate a concatinated file
with open(refout_all, 'w') as master_file:
    for sero_name in seros:
        #Where the REFGEN sero file is
        refout = ref_dir + 'NGS_' + sero_name + '_OUT/MSA_CORE_ST-' + sero_name
...
with open(refout_all + '_Sorted', 'a+') as sorted_master_file:
    #Go across genes
    for gene in genes:
