...
sero_list = [412, 415, 418, 483, 489, 507, 513, 538,
             541, 542, 674, 970, 971, 984, 1144, 1176, 1222, 1255]
...
pairs = np.array_split(complete_combolist, 50)
gene = ['CORE', 'FLEX']
