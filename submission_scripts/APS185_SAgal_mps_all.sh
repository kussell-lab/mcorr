...
MSA1=${ARCHIVE}/MSA_SAgal_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/250chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS185clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS185clusterseqs/${DATE}_slurm
