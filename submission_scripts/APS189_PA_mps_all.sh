...
MSA1=${ARCHIVE}/MSA_PA_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/20chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS189clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS189clusterseqs/${DATE}_slurm
