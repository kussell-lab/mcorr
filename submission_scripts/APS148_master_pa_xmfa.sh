...
WRKD=${SCRATCH}/recombo
#SRC is the directory your SRA accession files and genome files are within.
SRC=/home/aps376/APS148_paeruginosa
Archive=${SCRATCH}/recombo/APS148_PA_Archive
FASTA=$SRC/Reference/GCF_000006765.1_ASM676v1_genomic.fna
GFF=$SRC/Reference/GCF_000006765.1_ASM676v1_genomic.gff
sra_list=${SRC}/ncbi_sra_list
...
mkdir ${Archive}/PA_MASTER_OUT
cd ${Archive}/PA_MASTER_OUT

ReferenceAlignmentGenerate ${sra_list} ${WRKD}/paeruginosa ${FASTA} ${GFF} ${Archive}/PA_MASTER_OUT/MSA_PA_MASTER
