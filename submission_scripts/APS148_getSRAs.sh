...
mkdir -p $SCRATCH/recombo/paeruginosa
...
python3 $HOME/ReferenceAlignmentGenerator/FetchSRA_APS2.py $SCRATCH/recombo/APS148_SRA/APS148_SRA_list $SCRATCH/recombo/paeruginosa
