...
#define directories
threshold = 95
date = "0312_%s_all" % threshold
jobdir = "/scratch/aps376/recombo/APS170mcorr"
archive = "/scratch/aps376/recombo/APS170_SA_Archive/corethreshold%s" % threshold
submitdir = "/scratch/aps376/recombo/APS170mcorr/%s_submissions" % date
slurmdir = "/scratch/aps376/recombo/APS170mcorr/%s_slurm" % date
