...
#define directories
job_directory = "%s/APS140_btwnclades" %os.getcwd()
archive = "%s/APS140_ngs_Archive" %os.getcwd()
msadir = "%s/APS140_0929_CF_MSA" %os.getcwd()
...
wrkd = '/scratch/aps376/APS140_ngs_Archive'
for c in serocombs:
