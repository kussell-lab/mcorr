...
#define directories
job_directory = "/scratch/aps376/recombo/APS153_sa_btwnclades"
archive = "/scratch/aps376/recombo/APS153_saureus_Archive"
#scratch = os.environ['SCRATCH']
mkdir_p(archive)

"make all possible combos of clusters"

sero_list = [1, 2, 3, 4, 5, 6, 7, 9, 10, 13, 14, 16, 17, 19, 20, 25, 27, 28, 30]

serocombs = combinations(sero_list, 2)
complete_combolist = []

wrkd = '/scratch/aps376/recombo/APS153_saureus_Archive'
for c in serocombs:
...
for g in gene:
    ...
    for i in np.arange(0, 20):
        ...
        job_file = "%s_%s-%s.sh" % (g, str(i*9), str((i+1)*9))
        for c in combolist:
