...
JOBDIR=${SCRATCH}/APS138_cj_mp
OUTDIR=${SCRATCH}/APS138_Archive
MSA=${SCRATCH}/APS138_Archive/APS138_CJ_MASTER_MSA

mkdir -p $JOBDIR
mkdir -p $OUTDIR
##eventually do 0 to 79

for line in '200930' #{0..79}
do
...
#SBATCH --mem=16GB
#SBATCH --job-name=cj_$line
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=$JOBDIR/slurm%j_cj_mp_$line.out
...
echo \"let's rock\"
mcorr-pair $MSA $OUTDIR/cj_mp_MASTER_XMFA_OUT.csv  --max-corr-length=3" > $jobfile
    sbatch "$jobfile"
