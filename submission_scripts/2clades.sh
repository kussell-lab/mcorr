...
mcorr-xmfa-2clades ${WRKD}/Archive/Kentucky_OUT/REFGEN_Kentucky ${WRKD}/Archive/Newport_OUT/REFGEN_Newport ${OUTDIR}/KentuckyNewport_XMFA_OUT &&
mcorr-fit ${OUTDIR}/KentuckyNewport_XMFA_OUT.csv ${OUTDIR}/KentuckyNewport_FIT_OUT || true
