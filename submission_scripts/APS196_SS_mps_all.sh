...
MSA1=${ARCHIVE}/MSA_SS_MASTER_GAPFILTERED
MSA2DIR=${ARCHIVE}/250chunks
OUTDIR=${ARCHIVE}/${DATE}_${species}_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS196clusterseqs/${DATE}_submissions
SLURMDIR=/scratch/aps376/recombo/APS196clusterseqs/${DATE}_slurm
