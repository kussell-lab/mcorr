...
##make job directory
JOBDIR=$SCRATCH/APS136_singleclade
...
echo \"let's rock\"
mcorr-xmfa $OUTDIR/${line}_OUT/MSA_${gt}_${line} $OUTDIR/${line}_OUT/${line}_${gt}_XMFA_OUT &&
mcorr-fit $OUTDIR/${line}_OUT/${line}_${gt}_XMFA_OUT.csv $OUTDIR/${line}_OUT/${line}_${gt}_FIT_OUT || true" > $jobfile
    sbatch "$jobfile"
