...
#paths
DATE=1105
MSA1=/scratch/aps376/recombo/APS150_SP_Archive/SP_MASTER_OUT/MSA_SP_MASTER
MSA2DIR=/scratch/aps376/recombo/APS150_SP_Archive/SP_split_MSA
OUTDIR=/scratch/aps376/recombo/APS150_SP_Archive/1105_SP_mps_dists
SUBMITDIR=/scratch/aps376/recombo/APS150_sp_mps/1105_submissions
...
do
  ...
  MSA2=${MSA2DIR}/MSA_SP_MASTER_split${i}
  echo "#!/bin/bash
#SBATCH --nodes=1
